# About
This is latest version of  mathematical models for epithelial transport along the nephron implemented in Python 3. Models are species- and sex-specific and have options for disease states as well as pregnancy (see below). Related research papers are listed below. Please cite appropriately. To improve computation time, parallel computation of different types of nephron is implemented for the multiple nephron model. 
...
* mouse model is not completed for any case
