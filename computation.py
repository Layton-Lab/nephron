...
file=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_potential_gradient_Lumen_Cell'+sup_or_jux+'.txt','w')
for j in range(1,N):
	file.write(str(cell[j-1].ep[0]-cell[j-1].ep[1])+'\n')
file.close()

file=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_potential_gradient_Lumen_LIS'+sup_or_jux+'.txt','w')
for j in range(1,N):
	file.write(str(cell[j-1].ep[0]-cell[j-1].ep[4])+'\n')
file.close()

file=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_Na_conc_gradient_Lumen_LIS'+sup_or_jux+'.txt','w')
for j in range(1,N):
	file.write(str(cell[j-1].conc[0,0]-cell[j-1].conc[0,4])+'\n')
file.close()

file=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_Na_conc_gradient_Cell_LIS'+sup_or_jux+'.txt','w')
for j in range(1,N):
	file.write(str(cell[j-1].conc[0,1]-cell[j-1].conc[0,4])+'\n')
file.close()

file=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_pressure_in_Lumen'+sup_or_jux+'.txt','w')
for j in range(1,N):
	file.write(str(cell[j-1].pres[0])+'\n')
file.close()

for i in range(NS):
	file=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_con_of_'+solute[i]+'_in_Lumen'+sup_or_jux+'.txt','w')
	for j in range(1,N):
		file.write(str(cell[j-1].conc[i,0])+'\n')
	file.close()
for i in range(NS):
	file=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_con_of_'+solute[i]+'_in_Cell'+sup_or_jux+'.txt','w')
	for j in range(1,N):
		file.write(str(cell[j-1].conc[i,1])+'\n')
	file.close()
for i in range(NS):
	file=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_con_of_'+solute[i]+'_in_LIS'+sup_or_jux+'.txt','w')
	for j in range(1,N):
		file.write(str(cell[j-1].conc[i,4])+'\n')
	file.close()
for i in range(NS):
	file=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_con_of_'+solute[i]+'_in_Bath'+sup_or_jux+'.txt','w')
	for j in range(1,N):
		file.write(str(cell[j-1].conc[i,5])+'\n')
	file.close()

file=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_water_volume_in_Lumen'+sup_or_jux+'.txt','w')
for j in range(1,N):
	file.write(str(cell[j-1].vol[0]*cw)+'\n')
file.close()
file=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_water_volume_in_Cell'+sup_or_jux+'.txt','w')
for j in range(1,N):
	file.write(str(cell[j-1].vol[1]*cw)+'\n')
file.close()

file=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_pH_in_Lumen'+sup_or_jux+'.txt','w')
for j in range(1,N):
	file.write(str(-np.log(abs(cell[j-1].conc[11,0])/1000)/np.log(10))+'\n')
file.close()

for i in range(NS):
	file=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_flow_of_'+solute[i]+'_in_Lumen'+sup_or_jux+'.txt','w')
	for j in range(1,N):
		file.write(str(cell[j-1].conc[i,0]*cell[j-1].vol[0]*cw)+'\n')
	file.close()
for i in range(NS):
	file=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_flow_of_'+solute[i]+'_in_Cell'+sup_or_jux+'.txt','w')
	for j in range(1,N):
		file.write(str(cell[j-1].conc[i,1]*cell[j-1].vol[1]*cw)+'\n')
	file.close()

file_lumen = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_osmolality_in_Lumen'+sup_or_jux+'.txt','w')
file_cell = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_osmolality_in_Cell'+sup_or_jux+'.txt','w')
file_lis = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_osmolality_in_LIS'+sup_or_jux+'.txt','w')
file_bath = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_osmolality_in_Bath'+sup_or_jux+'.txt','w')
for j in range(N):
	osm_l = 0
	osm_c = 0
	osm_lis = 0
...
for j in range(1,N):
	...
	file_na_apical=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_Na_apical_ecd.txt','a')
	file_na_apical.write(str(jsol[0,0,1])+'\n')
	file_k_apical=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_K_apical_ecd.txt','a')
	file_k_apical.write(str(jsol[1,0,1])+'\n')
	file_nh4_apical=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_NH4_apical_ecd.txt','a')
	file_nh4_apical.write(str(jsol[10,0,1])+'\n')
	file_h_apical=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_H_apical_ecd.txt','a')
	file_h_apical.write(str(jsol[11,0,1])+'\n')
	file_cl_apical=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_Cl_apical_ecd.txt','a')
	file_cl_apical.write(str(jsol[2,0,1])+'\n')
	file_hco3_apical=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_HCO3_apical_ecd.txt','a')
	file_hco3_apical.write(str(jsol[3,0,1])+'\n')
	file_hpo4_apical=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_HPO4_apical_ecd.txt','a')
	file_hpo4_apical.write(str(jsol[6,0,1])+'\n')
	file_h2po4_apical=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_H2PO4_apical_ecd.txt','a')
	file_h2po4_apical.write(str(jsol[7,0,1])+'\n')
	file_hco2_apical=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_HCO2_apical_ecd.txt','a')
	file_hco2_apical.write(str(jsol[12,0,1])+'\n')
	file_nh3_apical=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_NH3_apical_ecd.txt','a')
	file_nh3_apical.write(str(jsol[9,0,1])+'\n')
	file_glu_apical=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_glu_apical_ecd.txt','a')
	file_glu_apical.write(str(jsol[14,0,1])+'\n')

	file_na_para=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_Na_para_ecd.txt','a')
	file_na_para.write(str(jsol[0,0,4])+'\n')
	file_k_para=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_K_para_ecd.txt','a')
	file_k_para.write(str(jsol[1,0,4])+'\n')
	file_nh4_para=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_NH4_para_ecd.txt','a')
	file_nh4_para.write(str(jsol[10,0,4])+'\n')
	file_h_para=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_H_para_ecd.txt','a')
	file_h_para.write(str(jsol[11,0,4])+'\n')
	file_cl_para=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_Cl_para_ecd.txt','a')
	file_cl_para.write(str(jsol[2,0,4])+'\n')
	file_hco3_para=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_HCO3_para_ecd.txt','a')
	file_hco3_para.write(str(jsol[3,0,4])+'\n')
	file_hpo4_para=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_HPO4_para_ecd.txt','a')
	file_hpo4_para.write(str(jsol[6,0,4])+'\n')
	file_h2po4_para=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_H2PO4_para_ecd.txt','a')
	file_h2po4_para.write(str(jsol[7,0,4])+'\n')
	file_hco2_para=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_HCO2_para_ecd.txt','a')
	file_hco2_para.write(str(jsol[12,0,4])+'\n')
	file_nh3_para=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_NH3_para_ecd.txt','a')
	file_nh3_para.write(str(jsol[9,0,4])+'\n')
	file_glu_para=open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_glu_para_ecd.txt','a')
	...
	for i in range(len(cell[j].trans)):
		...
		if transporter_type == 'SGLT1':
			...
			for k in range(len([solute_id])):
				file = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[j].segment+'_'+transporter_type+'_'+solute[solute_id]+str(memb_id[0])+str(memb_id[1])+'.txt','a')
...
file_Na_flux = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_Na_apical_flux'+sup_or_jux+'.txt','w')
file_K_flux = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_K_apical_flux'+sup_or_jux+'.txt','w')
file_NH4_flux = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_NH4_apical_flux'+sup_or_jux+'.txt','w')
file_H_flux = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_H_apical_flux'+sup_or_jux+'.txt','w')
file_Cl_flux = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_Cl_apical_flux'+sup_or_jux+'.txt','w')
file_HCO3_flux = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_HCO3_apical_flux'+sup_or_jux+'.txt','w')
file_HPO4_flux = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_HPO4_apical_flux'+sup_or_jux+'.txt','w')
file_H2PO4_flux = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_H2PO4_apical_flux'+sup_or_jux+'.txt','w')
file_HCO2_flux = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_HCO2_apical_flux'+sup_or_jux+'.txt','w')

file_Na_flux_para = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_Na_para_flux'+sup_or_jux+'.txt','w')
file_K_flux_para = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_K_para_flux'+sup_or_jux+'.txt','w')
file_NH4_flux_para = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_NH4_para_flux'+sup_or_jux+'.txt','w')
file_H_flux_para = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_H_para_flux'+sup_or_jux+'.txt','w')
file_Cl_flux_para = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_Cl_para_flux'+sup_or_jux+'.txt','w')
file_HCO3_flux_para = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_HCO3_para_flux'+sup_or_jux+'.txt','w')
file_HPO4_flux_para = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_HPO4_para_flux'+sup_or_jux+'.txt','w')
file_H2PO4_flux_para = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_H2PO4_para_flux'+sup_or_jux+'.txt','w')
file_HCO2_flux_para = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_HCO2_para_flux'+sup_or_jux+'.txt','w')

file_Na_flux_alpha = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_Na_alpha_flux'+sup_or_jux+'.txt','w')
file_K_flux_alpha = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_K_alpha_flux'+sup_or_jux+'.txt','w')
file_NH4_flux_alpha = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_NH4_alpha_flux'+sup_or_jux+'.txt','w')
file_H_flux_alpha = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_H_alpha_flux'+sup_or_jux+'.txt','w')
file_Cl_flux_alpha = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_Cl_alpha_flux'+sup_or_jux+'.txt','w')
file_HCO3_flux_alpha = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_HCO3_alpha_flux'+sup_or_jux+'.txt','w')
file_HPO4_flux_alpha = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_HPO4_alpha_flux'+sup_or_jux+'.txt','w')
file_H2PO4_flux_alpha = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_H2PO4_alpha_flux'+sup_or_jux+'.txt','w')
file_HCO2_flux_alpha = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_HCO2_alpha_flux'+sup_or_jux+'.txt','w')
file_Na_flux_beta = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_Na_beta_flux'+sup_or_jux+'.txt','w')
file_K_flux_beta = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_K_beta_flux'+sup_or_jux+'.txt','w')
file_NH4_flux_beta = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_NH4_beta_flux'+sup_or_jux+'.txt','w')
file_H_flux_beta = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_H_beta_flux'+sup_or_jux+'.txt','w')
file_Cl_flux_beta = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_Cl_beta_flux'+sup_or_jux+'.txt','w')
file_HCO3_flux_beta = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_HCO3_beta_flux'+sup_or_jux+'.txt','w')
file_HPO4_flux_beta = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_HPO4_beta_flux'+sup_or_jux+'.txt','w')
file_H2PO4_flux_beta = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_H2PO4_beta_flux'+sup_or_jux+'.txt','w')
file_HCO2_flux_beta = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_HCO2_beta_flux'+sup_or_jux+'.txt','w')

file_K_flux_total = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_K_total_flux'+sup_or_jux+'.txt','w')
file_Na_flux_total = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_Na_total_flux'+sup_or_jux+'.txt','w')
file_Na_flux_baso = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_Na_baso_flux'+sup_or_jux+'.txt','w')
file_Na_flux_Cell_LIS = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_Na_Cell_LIS_flux'+sup_or_jux+'.txt','w')
file_water_flux = open('./'+file_to_save+'/'+sex_or_preg+'_'+humOrrat[0:3]+'_'+cell[0].segment+'_water_flux_apical'+sup_or_jux+'.txt','w')
